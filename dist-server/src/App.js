...
const App = ({
  ...
  let pageRenderer = page => {
    switch (page) {
      case 'profile':
        return /*#__PURE__*/_react.default.createElement(_profile.Profile, {
          data: data
        });
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, pageRenderer(page));
};
