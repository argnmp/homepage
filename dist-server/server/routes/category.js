...
router.get('/:upperdirectory/:lowerdirectory/:post', (req, res) => {
  ...
  const currentPageData = _fs.default.readFileSync(_path.default.resolve(__dirname, `../static/post/${req.params.upperdirectory}/${req.params.lowerdirectory}/${req.params.post}/index.html`), 'utf8'); //using redux to send data from server to client
